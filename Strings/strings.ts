...
function StringFunction():void{
    ...
    const stri2:string=str1+" SI SALE";
...
function todas() : void{
let parametro : string="oy ganO compi2"
   let hola:string="H";
   let ache:string=hola.charAt(0) ;
   let todo:string="H"+parametro;
