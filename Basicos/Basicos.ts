...
//hasta aqui bien
//aqui lo meti en una funcion
//console.log(aritmeticas)
function f1():void{
   // let logicas:number=5;
   // let aritmeticas:number=0
    //let relacionales:number=0;
    let num1: number = (25 + 8 * 3) / (3125 - 2 + 9);
let num2: number = (5 * 5 + 2 * 3 * 3) / (3125 - 2 + 3);
let num3: number = (5 + 5 + 10 + 6 + 9) / (5 * 2) ** 2;
let num4: number = 5 ** 5 + 5 ** 5;


if ( false == false) { //0.015 > 0.013
    if(num1+num2-num3-num4 != (num1+num2-num3-num4-1)){
        relacionales = 5;
       // console.log("relacional correcta ")
    }
}
else {
...
console.log("SENTENCIAS ESCAPE SALTO DE LINEA");
console.log("TABLERO BINARIO CON TABULACIONES");
console.log("0\t"+"\t1"+"\t0"+"\t1"+"\t0"+"\t1"+"\t0"+"\t1"+"\t1\n");
console.log("1\t"+"\t0"+"\t1"+"\t0"+"\t1"+"\t0"+"\t1"+"\t0"+"\t0\n");
console.log("0\t"+"\t1"+"\t0"+"\t1"+"\t0"+"\t1"+"\t0"+"\t1"+"\t1\n");
console.log("1\t"+"\t0"+"\t1"+"\t0"+"\t1"+"\t0"+"\t1"+"\t0"+"\t0\n");
}
f1();
